...
const my3FavoriteTVShows = ['Breaking bad', 'Watchmen', 'The Boys']
...
// console.log(`A string que a "typeSentence" armazena tem mais de ${num} caracteres? ${num == typeSentence.length}.`.replace('f', 'F'));
...
// console.log(crazyConversion); // Resulta em true devido a soma do crazyOperation, onde o null é considerado como 0, então 0 + 1 = 1, e o número 1 é considerado como um truthy
