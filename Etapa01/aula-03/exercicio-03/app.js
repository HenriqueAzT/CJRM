...
let add = brazilianFoods.push('coxinha', null, 'Brigadeiro')
...
const replace = dessert.replace('n', 'd')
//console.log(`A ${replace} é um doce à base de coco, tradicional na América Latina e em Angola`);
