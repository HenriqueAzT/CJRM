...
console.log(`O crazyArray tem ${numBool} booleans, ${numInt} números e ${numString} strings.`);
...
for(let i = 0; i < randomNumbers.length; i++){
    ...
    isEvenNumber = randomNumbers[i] % 2 == 0
    if(isEvenNumber){
        pair.push(number)
    }else{
        odd.push(number)
...
const evenNumbersString = pair.join(', ').replace(', 5', ' e 5')
