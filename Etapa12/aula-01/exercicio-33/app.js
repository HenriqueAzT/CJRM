...
const swapItems = ([first, , third]) => [third, first] 



console.log(swapItems([54, 68, 3]));
...
const greet = (obj, dynName) => {
  const { [dynName]: name = 'desconhecido'} = obj
  return `Olá, meu nome é ${name}`
}

console.log(greet({ name: 'Henrique' }, 'name'))
