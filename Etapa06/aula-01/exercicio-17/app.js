...
const handleSubmit = (event) => {
  ...
  // const inputRegex = /.{7,}/ // Questão numero 6
  const inputRegex = /[a-zA-Z0-9]{7,11}/ // Questão numero 7
  const inputResult = inputRegex.test(input.value)
  if (inputResult) {
...
const pattern = /[a-z]{10,}/

const isAMatch = pattern.test(a.innerText)
