...
const numbersLowerThan501 = crazyNumbers.reduce(countNumbersLessThan501, 0)
...
const before2000Movies = tarantinoMovies.filter(({release}) => release < 2000)

console.log(before2000Movies);
