...
const convertedString = convertToString(1232)
...
const word = stringLength('Abacate')
...
stringToLowerCase('CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO')
...
const stringIndex = (value, index) =>{
  let indexA = value.indexOf(index)
  return indexA
}

let randomString = stringIndex('carro', 'a')
...
const randomArray = ['Ferrari', 'Mercedes', 'Lamborghini']

const isItemInArray = (value, randomArray) => {
  return randomArray.includes(value)
}

const carModel = isItemInArray('Ferrari', randomArray)
...
const arrayConcatenation = (value1, value2) => {
  return value1.concat(value2)
}

const arrays = arrayConcatenation(array1, array2)
...
const arrayPop = (value) => {
  return value.pop()
}

const newArray = arrayPop(arrays)
...
const isNull = verifyIfNull(null)
...
const valuetimes3 = (value, callback) => {
  return callback(value)
}

const triple = number => number * 3

console.log(valuetimes3(33, triple));
...
letters.forEach((letter) => {
  return lettersCopy.push(letter)
})
...
console.log(getLikesMessage(['Caio', 'Lara', 'Clara', 'Cleber', 'Maria', 'Mariana']));
