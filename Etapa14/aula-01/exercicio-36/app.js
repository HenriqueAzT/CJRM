...
const myFirstName = 'henrique'
const capitalizedName = [...myFirstName.replace('h', 'H')].join('')
...
const dateValues = timestamps.reduce((acc, timestamp) => {
...
const carouselItem = document.querySelector('[data-js="carousel__item"]')
