...
const reversedNumbers = randomNumbers.reverse()
...
let dogName = dogs.name

const findName = dogs.find(dog => dog.name === 'Zequinha')
...
const paragraphs = document.querySelectorAll('.secondary-title')
