...
const showEggCoordinates = ({offsetX, offsetY}) => {
...
egg.addEventListener('mousemove', showEggCoordinates)
...
const ifProfessionIsTrue = people.some(({profession}) => 
  profession === 'Front-end developer')

if (ifProfessionIsTrue) {
